 ...
 */
@BusInterface(name = "org.allseen.LSF.LampState", announced = "true")
public interface LampState {
    ...
    int applyPulseEffect(HashMap<String, Variant> FromState, HashMap<String, Variant> ToState, int period, int duration, int numPulses,
            long timestamp) throws BusException;
    ...
    int getVersionState() throws BusException;
    ...
    /* The BusSignal annotation signifies this signal should be used as part of
     * the AllJoyn interface.
     * 
     * All signals that use the BusSignal annotation can throw a BusException
     * and should indicate this fact. */
    @BusSignal(name = "LampStateChanged", replySignature = "s", sessionless = true)
